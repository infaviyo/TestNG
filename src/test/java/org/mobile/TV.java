...
public class TV {
		...
		public Object[][]Tvdetails(){
			return new Object[][] {{"miTv"}};}
	...
	public static void BrowserQuit() {
		...
		@Test(priority=2,groups="smoke",dataProvider = "Tv")
		...
		search.sendKeys(name,Keys.ENTER);}
			...
			public void Tv() {
				...
				System.out.println("TvOption");
			}
			@Test(priority=5,groups="smoke")
			public void WindowHandle() {
				String mi = driver.getWindowHandle();
				Set<String> Tv = driver.getWindowHandles();
				for(String x :Tv) {
					if(!x.equals(mi)) {
